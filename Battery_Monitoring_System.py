...
while True:
    ...
    print("Voltage output:"+str(round(v_out,2))+"V")
    print("Voltage input:"+str(round(v_in,2))+"V")
    print("Battery Percentage:"+str(battery_percent(v_in))+"%")
    oled.fill_rect(20,40,108,20,0)
    oled.text("Vin:"+str(round(v_in,2))+"V",20,40)
    oled.text("(%):"+str(battery_percent(v_in))+"%",20,50)
    oled.show()
    utime.sleep(1)
